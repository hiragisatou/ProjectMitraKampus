                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-sm d-flex">:
                            <div class="row ms-1">
                                <div class="col">
                                    <a class="btn btn-icon btn-sm btn-info m-0" type="button" target="_blank" href="{{ asset('storage/' . $data['mou_file']) }}">
                                ...
                                @if ($data['verifymou'] != null && $data['verifymou']['status'] == 'verify')
                                    <div class="col">
                                        <a class="btn btn-icon btn-sm btn-success" type="button" target="_blank" href="{{ asset('storage/' . $data['verifymou']['valid_mou_file']) }}">
                                            <span class="btn-inner--icon"><i class="fa-solid fa-file-pen"></i></span>
