...
@section('content')
    <div class="card p-3">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h5 class="m-0 align-middle">Data Jenis Mitra</h5>
                <button type="button" class="btn bg-gradient-success btn-block mb-3" data-bs-toggle="modal" data-bs-target="#addModal">
                    <span class="me-2"><i class="fa-solid fa-plus"></i></span> Tambah Jenis Mitra
                </button>
            </div>
            <table class="table" id="mytable">
                <thead>
                    <tr>
                        ...
                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 p-2">Nama Jenis</th>
                        ...
                        <tr>
                            ...
                            <td class="text-sm font-weight-bold mb-0">
                                <div class="d-flex">
                                    ...
                                    <button type="button" class="btn bg-gradient-danger m-0 py-1 px-2" data-bs-toggle="modal" data-bs-target="#modal-notification" data-bs-url="{{ route('delete_jenis_mitra', ['jenis' => $x->id]) }}" data-bs-name="{{ $x->nama }}"><i class="fa-regular fa-trash-can"></i></button>
                                </div>
                            </td>
                        </tr>
                    @endforeach
    ...
    <div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="addModalTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('jenis_mitra_handler') }}" method="POST">
                    <div class="modal-body">
                        @csrf
                        <input type="hidden" name="id" value="{{ $id }}">
                        <div class="form-group">
                            <label for="message-text" class="col-form-label">Nama Jenis</label>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#breadcrumb').append('<li class="breadcrumb-item text-sm text-dark active" aria-current="page">Jenis Mitra</li>');
            ...
            $('#addModal').find('form').validate({
                ...
                messages: {
                    name: {
                        required: 'Nama jenis mitra wajib diisi.',
                    }
                },
                errorElement: "div",
