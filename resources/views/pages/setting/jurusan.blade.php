                        ...
                        <tr>
                            ...
                            <td class="text-sm font-weight-bold mb-0">
                                <div class="d-flex">
                                    ...
                                    <button type="button" class="btn bg-gradient-danger m-0 py-1 px-2" data-bs-toggle="modal" data-bs-target="#modal-notification" data-bs-url="{{ route('delete_jurusan', ['jurusan' => $x->id]) }}" data-bs-name="{{ $x->name }}"><i class="fa-regular fa-trash-can"></i></button>
                                </div>
                            </td>
                        </tr>
                    @endforeach
