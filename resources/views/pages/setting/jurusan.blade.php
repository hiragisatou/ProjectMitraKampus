...
@section('content')
                        ...
                        <tr>
                            ...
                            <td class="text-sm font-weight-bold mb-0">
                                <div class="d-flex">
                                    ...
                                    <button type="button" class="btn bg-gradient-danger m-0 py-1 px-2" data-bs-toggle="modal" data-bs-target="#modal-notification" data-bs-url="{{ route('delete_jurusan', ['jurusan' => $x->id]) }}" data-bs-name="{{ $x->nama }}"><i class="fa-regular fa-trash-can"></i></button>
                                </div>
                            </td>
                        </tr>
                    @endforeach
    ...
    <div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="addModalTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('jurusan_handler') }}" method="POST">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#breadcrumb').append('<li class="breadcrumb-item text-sm text-dark active" aria-current="page">Jurusan</li>');
            ...
            $('#modal-notification').on('show.bs.modal', event => {
                ...
                $('#modal-notification').find('p:first').text("Apakah anda yakin menghapus jurusan " + name + " ?")
            });
