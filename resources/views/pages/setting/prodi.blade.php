                ...
                <tbody>
                    @foreach ($data as $x)
                        <tr>
                            ...
                            <td class="text-sm font-weight-bold mb-0">{{ $x->jurusan->name }}</td>
                            <td class="text-sm font-weight-bold mb-0">
                                <div class="d-flex">
                                    ...
                                    {{-- <form action="{{ route('delete_prodi', ['prodi' => $x->id]) }}" method="post" class="m-0 p-0">
                                        @method('delete')
                                        @csrf
                                        <button type="submit" class="btn bg-gradient-danger m-0 py-1 px-2">
