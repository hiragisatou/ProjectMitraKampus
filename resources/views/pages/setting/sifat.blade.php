    ...
    <div class="card p-3">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h5 class="m-0 align-middle">Data Sifat Mitra</h5>
                        ...
                        <tr>
                            ...
                            <td class="text-sm font-weight-bold mb-0">
                                <div class="d-flex">
                                    ...
                                    <button type="button" class="btn bg-gradient-danger m-0 py-1 px-2" data-bs-toggle="modal" data-bs-target="#modal-notification" data-bs-url="{{ route('delete_sifat_mitra', ['sifat' => $x->id]) }}" data-bs-name="{{ $x->nama }}"><i class="fa-regular fa-trash-can"></i></button>
                                </div>
                            </td>
                        </tr>
                    @endforeach
